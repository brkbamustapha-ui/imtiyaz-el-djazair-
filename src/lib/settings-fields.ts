...
export const GENERAL_FIELDS: Field[] = [
  ...
  { name: "logoUrl", label: "Logo", type: "image", group: "Branding", help: "Leave as /assets/logo.svg to use the built-in mark." },
  { name: "faviconUrl", label: "Favicon", type: "image", group: "Branding", help: "An SVG or square PNG." },
